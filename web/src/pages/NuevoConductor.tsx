      ...
      <div className="flex-1 flex flex-col overflow-hidden p-8">
        ...
        <div className="bg-white flex-1 rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="flex items-center gap-3 mb-8 border-b border-gray-100 pb-4">
            <UserPlus className="text-[#3779CB] w-8 h-8" />
            <h2 className="text-2xl font-bold text-[#1A2847]">Registrar Nuevo Conductor</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="nombre" className="font-semibold text-gray-700">Nombre Completo *</label>
                    <input
                      type="text"
                      id="nombre"
                      name="nombre"
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="correo" className="font-semibold text-gray-700">Correo Electrónico *</label>
                    <input
                      type="email"
                      id="correo"
                      name="correo"
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="licencia" className="font-semibold text-gray-700">Tipo de Licencia *</label>
                    <select
                      id="licencia"
                      name="licencia"
            ...
            <div className="lg:col-span-1">
              <label className="font-semibold text-gray-700 block mb-2">Foto de Perfil (Opcional)</label>
              <div className="border-2 border-dashed border-gray-300 rounded-xl h-64 flex flex-col items-center justify-center bg-gray-50 text-gray-400 hover:bg-gray-100 transition-colors cursor-pointer">
                <div className="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mb-4">
                  <Camera className="w-8 h-8 text-[#3779CB] opacity-60" />
                </div>
                <span className="font-medium text-gray-600">Subir fotografía</span>
                <span className="text-sm mt-1 text-gray-400 text-center px-4">Formatos recomendados: JPG, PNG</span>
              </div>
            </div>
